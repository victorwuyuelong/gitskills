...
//1.0
        ...
        public void Put_SendInfoToPool(string key, string data, Socket sendSocket)
        {
            ...
            if (CurrentSendDataMode == DataMode.Text)
            {
                ...
                //  m = m;
                byteArr = System.Text.Encoding.Default.GetBytes(m);        
                //  txtString.Text
        ...
        public void OnConnectRequest(IAsyncResult ar)
        {
            try
            {
                ...
                byteDateLine = System.Text.Encoding.Default.GetBytes(strDateLine);
                //将提示信息发送给客户端
        ...
        public void OnDataReceived(IAsyncResult asyn)
        {
           ...
           // char[] chars1 = Encoding.Default.GetChars(socketData.dataBuffer);
            try
            {
                ...
                {
                    //stringdata = Encoding.ASCII.GetString(byteDateLine, 0, recv);
                    //char[] chars1 = Encoding.UTF8.GetChars(socketData.dataBuffer);
                    //MessageBox.Show(Convert.ToString(stringdata +"text"));
                    stringdata = szData;
